...
fn test_cache_operations() {
    ...
    let level0_hashes = vec![b"hash1".to_vec(), b"hash2".to_vec()];
    let level1_hashes = vec![b"parent_hash".to_vec()];
...
fn test_clear_cache() {
    ...
    let cache_levels = vec![vec![b"leaf1".to_vec()], vec![b"parent".to_vec()]];
